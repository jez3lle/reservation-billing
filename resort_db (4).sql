...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2025 at 06:24 PM
...
(20, 'KS2504166773', '2025-04-16', '2025-04-17', 'Keith', 'Samosa', 'k8.example@yahoo.com', '09125663432', 23, 24, '0', '', 1, 1, 1, 28200.00, 250.00, 28450.00, '2025-04-06 15:48:13');
...
INSERT INTO `p2_guest_reservation` (`id`, `booking_reference`, `check_in_date`, `check_out_date`, `adults`, `children`, `total_amount`, `first_name`, `last_name`, `email`, `contact_number`, `special_requests`, `payment_method`, `payment_details`, `status`, `created_at`, `updated_at`) VALUES
...
(2, 'GLASS CABIN', 1500.00, 2000.00, 'Perfect for couple or small family. Good for 2-4pax', 4, 'images/glass_cabin_main.jpg', 'Available'),
...
(6, 'KUBO ROOM', 1500.00, 2000.00, 'Perfect for couple or small family. Good for 2-4pax', 2, 'images/kubo_room_main.jpg', 'Available'),
